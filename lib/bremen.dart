...
class bremen extends StatefulWidget {
  @override
  _bremenState createState() => _bremenState();
}

class _bremenState extends State<bremen> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Bremen Mızıkacıları'),
      ),
